...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/trello-ucm",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/trello-ucm.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/trello-ucm/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called trello-ucm which is linked to
    //./bin/trello-ucm in the local package.

    //If we have installed this package globally using npm install trello-ucm
    //-g we will be able to call this new command trello-ucm from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/trello-ucm.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/trello-ucm.js"
    }
};
